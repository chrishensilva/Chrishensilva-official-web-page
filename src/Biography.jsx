            ...
            <div className="bio-container">
                <div className="bio-body">
                    ...
                    <div className='viewcount'>
                        <h2 className='viewh1'><div className='yt'>257k+</div>YOUTUBE VIEWS</h2>
                        <h2 className='viewh2'><div className='streams'>1800+</div>STREAMS</h2>
                        <h2 className='viewh3'><div className='relno'>59</div>RELEASES</h2>
                    </div>
                </div>
                <div className="bio-img">
                    ...
                    <div className="bio-overlay-middleR">
                        <p className="bio-cmt">Awesome work🥰🥰Keep it up....All the best 👍👍</p>
                        <p className="platform">-YouTube-</p>
                    </div>
                    <div className="bio-overlay-middleL">
                        <p className="bio-cmt">We can't stop listening to this, this is the 10000 time listening to it but still love it the same😭❤</p>
                        <p className="platform">-YouTube-</p>
                    </div>
                </div>
            </div>
